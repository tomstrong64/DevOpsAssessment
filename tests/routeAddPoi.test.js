...
describe('POST /pois/addPoi', () => {
    it('should add new POI', async () => {
        ...
        .set('Authorization','Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY1NGNjNTRjMjI0NTRhY2QyNTEyNTZlMyIsImlhdCI6MTY5OTk1OTk1NCwiZXhwIjoxNzAwMDQ2MzU0fQ.jfzCKYEK9n3-i4jvb7a_ODPazXT-dusLPanxnF6xEpk');
...
describe('GET /pois/list?search=poi_region', () => {
  ...
  it('should return POIs by region name', async () => {
   const response = await request(app).get(`/pois/list?search=${poi_region}`)
    .set('Authorization','Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY1NGNjNTRjMjI0NTRhY2QyNTEyNTZlMyIsImlhdCI6MTY5OTk1OTk1NCwiZXhwIjoxNzAwMDQ2MzU0fQ.jfzCKYEK9n3-i4jvb7a_ODPazXT-dusLPanxnF6xEpk');
...
it('should return all POIs when no query parameters are provided', async () => {
  const response = await request(app).get('/pois/list')
  .set('Authorization','Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY1NGNjNTRjMjI0NTRhY2QyNTEyNTZlMyIsImlhdCI6MTY5OTk1OTk1NCwiZXhwIjoxNzAwMDQ2MzU0fQ.jfzCKYEK9n3-i4jvb7a_ODPazXT-dusLPanxnF6xEpk');
